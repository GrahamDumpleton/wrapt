...
class _LRUCacheBoundWrapper(BoundFunctionWrapper):
...
class _LRUCacheWrapper(FunctionWrapper):

    __bound_function_wrapper__ = _LRUCacheBoundWrapper
...
def lru_cache(func=None, /, **kwargs):
    ...
    return decorator(_wrapper, proxy=_LRUCacheWrapper)(func)
