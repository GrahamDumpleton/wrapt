...
project = "wrapt"
copyright = "2013-2026, Graham Dumpleton"
...
# The logo lives here, and is copied into the build output alongside the
...
latex_documents = [
    ("index", "wrapt.tex", "wrapt Documentation", "Graham Dumpleton", "manual"),
]
...
man_pages = [("index", "wrapt", "wrapt Documentation", ["Graham Dumpleton"], 1)]
